  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Dashboard</h1>
              <p className="text-muted-foreground">
                Welcome back, {currentUser?.name}
                {currentUser?.organizationName && ` from ${currentUser.organizationName}`}
              </p>
            </div>
